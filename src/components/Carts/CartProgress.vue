<template>
  <div class="progress-container">
    ...
    <div class="circle" :class="{ 'active': props.progress.circle2.value }">2</div>
    <div class="circle" :class="{ 'active': props.progress.circle3.value }">3</div>
    <div class="circle" :class="{ 'active': props.progress.circle4.value }">4</div>
  </div>
</template>
...
const num = props.progress.progressNum
</script>
